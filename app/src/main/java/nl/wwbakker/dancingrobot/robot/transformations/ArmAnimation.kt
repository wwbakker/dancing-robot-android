...
import nl.wwbakker.dancingrobot.robot.AnimationHelper.interpolateBackAndForth
...
class ArmAnimation(private var counter : Long = 0L) : Animation {
    ...
    fun transformSide(limbType: LimbType, limb: Array<nl.wwbakker.dancingrobot.Coordinate>): Array<nl.wwbakker.dancingrobot.Coordinate> {
        ...
        fun upperArm(left : Boolean) : Array<nl.wwbakker.dancingrobot.Coordinate> {
        ...
        fun lowerArm(left: Boolean) : Array<nl.wwbakker.dancingrobot.Coordinate> {
        ...
        fun hand(left: Boolean) : Array<nl.wwbakker.dancingrobot.Coordinate> {
    ...
    fun transformForward(limbType: LimbType, limb: Array<nl.wwbakker.dancingrobot.Coordinate>): Array<nl.wwbakker.dancingrobot.Coordinate> {
