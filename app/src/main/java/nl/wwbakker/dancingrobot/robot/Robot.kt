...
import nl.wwbakker.dancingrobot.*
import nl.wwbakker.dancingrobot.robot.LimbType.*
import nl.wwbakker.dancingrobot.robot.transformations.*
...
//        DebugSideView(),
    ...
    fun draw(canvas: Canvas) {
        val cube = nl.wwbakker.dancingrobot.DrawHelper.cube_vertices
        values().map { limbType ->
            ...
            nl.wwbakker.dancingrobot.DrawHelper.drawAndFillCube(canvas, limbAndLimbType.first, limbToColor(limbAndLimbType.second))
        }
    }
